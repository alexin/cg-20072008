 ...
 */
public class LightPage extends HeaderPage {
    ...
    private LightTypeBoxModel boxModel;
    private Controller controller;
    private ArrayList<String> ids;

    static {
        HEADER_TITLE = "Create a new Light";
        HEADER_DESCRIPTION = "Type the name of the Light and select its type.";
    }

    public LightPage(ArrayList<String> ids) {
        this.controller = new Controller();
        this.boxModel = new LightTypeBoxModel(Manager.LIGHT_TYPES);
        this.ids = ids;
    ...
    public LightType getLightType() {
        return boxModel.getSelectedLightType();
    }
        ...
        public void insertUpdate(DocumentEvent de) {
            ...
            if (!nameField.getText().equals("") && nameField.getText() != null) {
                if (ids.contains(nameField.getText())) {
                    getWizard().disableFinishButton();
                    warningLabel.setText("* The Light '" + nameField.getText() + "' already exists");
                } else {
